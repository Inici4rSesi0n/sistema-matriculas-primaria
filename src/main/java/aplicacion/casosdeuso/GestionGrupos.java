...
public class GestionGrupos {
    ...
    public List<Grupo> buscarPorNombreYGrado(String nombreGrupo, String nombreGrado) {
        return repo.buscarPorNombreYGrado(nombreGrupo, nombreGrado);
    }
    ...
    public void actualizarGrupo(Grupo original, String nuevoNombre, Grado nuevoGrado) {
        ...
        if (nuevoGrado == null) {
            throw new IllegalArgumentException("El nuevo grado no puede ser nulo.");
        }
    ...
    public void asignarTutor(Grupo grupo, Docente tutor) {
        if (grupo == null || tutor == null) {
            throw new IllegalArgumentException("Grupo y tutor son obligatorios.");
        }
